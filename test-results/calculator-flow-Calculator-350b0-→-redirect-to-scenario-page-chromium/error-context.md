...
- Name: Calculator Flow Integration >> complete flow: form submission → loading → redirect to scenario page
- Location: /Users/reshtei/work/Vibe projects/Future Value Investment Calculator/future-value-app/tests/calculator-flow.spec.ts:12:7
...
Call log:
  - waiting for locator('[data-testid="initial-amount-input"]')

    at /Users/reshtei/work/Vibe projects/Future Value Investment Calculator/future-value-app/tests/calculator-flow.spec.ts:16:16
```
